...
public class QuizWrapper_ps {
    ...
    public QuizWrapper_ps(int id, String question, String questionurl, int questiontypeid, String questioncontent, int optioncount, JSONArray optionsformatching, String option1, String option1id, String option2, String option2id, String option3, String option3id, String option4, String option4id, String option5, String option5id, String answer, JSONArray matchingans) {
